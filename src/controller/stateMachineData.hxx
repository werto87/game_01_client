...
typedef std::variant<std::monostate, shared_class::DurakDefendError, shared_class::DurakAttackError, shared_class::CreateGameLobbyError, shared_class::JoinGameLobbyError, shared_class::LoginAccountError, shared_class::WantToRelog, shared_class::CreateAccountError, shared_class::SetMaxUserSizeInCreateGameLobbyError> MessageBoxEvent;
