...
, state<GameWaitForServer>  + event<shared_class::DurakAssistPassError>                                       / setErrorEvent
, state<GameWaitForServer>  + event<shared_class::DurakAttackPassError>                                       / setErrorEvent
...
,*"anystate"_s              + event<shared_class::DurakGameOverWon>                                           / setDurakGameOverWon
, "anystate"_s              + event<shared_class::DurakGameOverLose>                                          / setDurakGameOverLose
