...
, state<Lobby>                        + event<draw>                                               / (drawLobby,evalLobby,evalChatLobby)         
...
, state<CreateGameLobby>              + event<draw>                                               / (drawCreateGameLobby,evalCreateGameLobby,evalChatCreateGameLobby)  
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
